...
#ifndef RMGF_FOOTBOT_CIRCULAR_H
#define RMGF_FOOTBOT_CIRCULAR_H
...
// RMGF: for this simple robot we do not need sensors
 ...
 */
class CRMGFFootBotCircular : public CCI_Controller {

public:

   /* Class constructor. */
   CRMGFFootBotCircular();

   /* Class destructor. */
   virtual ~CRMGFFootBotCircular() {}
